        ...
        {menu_list.map((menuItem) => (
          ...
          >
            <img
              ...
              className={`h-20 w-20 md:h-30 md:w-30 object-cover ${category === menuItem.menu_name ? "border-amber-500 border-4 rounded-full" : "border-4 border-transparent hover:border-amber-300 rounded-full duration-200"}`}
            />
